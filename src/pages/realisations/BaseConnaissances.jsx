...
export default function BaseConnaissances() {
  ...
  const pourQuiProofs = getProjectProofs('baseConnaissances', 'pourQui')
  const pourQuoiProofs = getProjectProofs('baseConnaissances', 'pourQuoi')
  const commentProofs = getProjectProofs('baseConnaissances', 'comment')
  const ceQueJaiFailProofs = getProjectProofs('baseConnaissances', 'ceQueJaiFait')
